...
const activityIcons: Record<ActivityType, LucideIcon> = {
  ...
  statistics_published: PenSquare,
  statistics_created: FilePlus,
  statistics_updated: FileEdit,
  statistics_deleted: FileX,
...
const activityLabels: Record<ActivityType, string> = {
  ...
  statistics_published: 'Statistic Published',
...
const activityColors: Record<ActivityType, string> = {
  ...
  statistics_published: 'bg-green-500/10 text-green-500',
  statistics_created: 'bg-emerald-500/10 text-emerald-500',
  statistics_updated: 'bg-teal-500/10 text-teal-500',
  statistics_deleted: 'bg-red-500/10 text-red-500',
